...
def glossary(term=None, return_format=None):
    ...
    :param term: a whole or partial word to "search" in the API
    """
    uri = "glossary"
    if term:
        uri = "/".join([uri, term])
...
def threatfeeds_ipsperfeedperday(
    feed=None, start_date=None, end_date=None, return_format=None
):
    """Ommit the feed name to list all.

    :param feed_list: string
    :param start_date: string or datetime.date()
    :param end_date: string or datetime.date()
    """
    uri = "threatfeeds/feedperday"
...
def threatfeeds_ipsinfeedcategory(
    category, start_date=None, end_date=None, return_format=None
):
    """Similar to the data above, but for a specific category. By default 
    you will get data from the last 7 days.
...
def webhoneypotbytype(return_format=None):
...
def threatfeeds_ipsperfeedperday(feed_list=None, start_date=None, end_date=None, return_format=None):
    """Ommit the feed name to list all.
...
def threatfeeds_ipsinfeedcategory(category, start_date=None, end_date=None, return_format=None):
